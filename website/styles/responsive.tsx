...
export const screenWidthLess = (key: string) =>
  `@media screen and (max-width: ${breakpoints[key]})`;

export const screenWidthLessPx = (px: string) =>
  `@media screen and (max-width: ${px})`;

export const screenWidthBetween = (keyMin: string, keyMax: string) =>
  `@media (min-width: ${breakpoints[keyMin]}) and (max-width: ${
  breakpoints[keyMax]
  })`;
...
export const screenHeightBetween = (keyMin: string, keyMax: string) =>
  `@media (min-height: ${heightBreakpoints[keyMin]}) and (max-height: ${
  heightBreakpoints[keyMax]
  })`;
